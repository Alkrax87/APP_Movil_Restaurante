...
import com.example.demoapp.databinding.ActivityMapUserBinding;
...
public class Map_User extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng location = new LatLng(-16.418051, -71.526601);
        mMap.addMarker(new MarkerOptions().position(location).title("Tradición Arequipeña"));
