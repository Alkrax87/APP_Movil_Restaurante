...
public class AdminOrdersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.orders_admin_fragment,container,false);

        title = root.findViewById(R.id.txtNameFood);
        description = root.findViewById(R.id.txtDescription);
        price = root.findViewById(R.id.txtPriceAdd);
